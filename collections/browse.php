<?php
if ($pageTitle = __(get_theme_option("Browse Collection Title"))) {
...
<div class="collection record">
    ...
    <?php if ($collectionImage = record_image('collection', 'fullsize') and $browse_collection_image = get_theme_option("Browse Collection Image")): ?>
